...
namespace TripAdvertisement.Controllers
{
    ...
    public class CustomersController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,FullName,UserName,Email,PhoneNum,Role")] Customers customers)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,FullName,UserName,Email,PhoneNum,Role")] Customers customers)
        {
            if (ModelState.IsValid)
            {
        ...
        public ActionResult Locations(int id )
        {
            ...
            var list = cust.Locations.ToList();
